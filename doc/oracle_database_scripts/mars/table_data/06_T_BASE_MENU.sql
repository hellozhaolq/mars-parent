prompt Loading T_BASE_MENU...
insert into T_BASE_MENU (id, name, code, remark, perms, type, url_type, url, scheme, path, target, parent_id, order_num, icon, create_by, create_time, last_update_by, last_update_time, status, del_flag)
