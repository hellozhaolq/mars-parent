 ...
 * <p>
 * 推荐阅读：https://www.baeldung.com/properties-with-spring
 * <p>
 * 注解@PropertySource 用于指定资源文件读取的位置，它不仅能读取properties文件，也能读取xml文件，并且通过YAML解析器解析YAML文件。
 ...
 * <p>
 * 注解@PropertySource 可以将PropertySource添加到Spring的Environmen。示例见 ConfigInfoTest。
 * <p>
 * 友情提示:
