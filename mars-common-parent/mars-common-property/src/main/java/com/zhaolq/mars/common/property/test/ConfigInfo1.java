 ...
 *
 * @PropertySource注解：
 *      用于指定资源文件读取的位置，它不仅能读取properties文件，也能读取xml文件，并且通过YAML解析器解析YAML文件。
 *      默认的PropertySourceFactory实现只能解析application.yml，自定义实现参考 https://blog.csdn.net/qq_40837310/article/details/106587158。
 *      不配置，默认读取 application.yml 和 application.properties
 *
 * 友情提示:
