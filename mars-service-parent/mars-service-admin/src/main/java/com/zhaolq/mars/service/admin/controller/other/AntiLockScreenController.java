...
import com.zhaolq.mars.service.admin.schedule.MouseMoveSched;
...
public class AntiLockScreenController {
    @Autowired
    private MouseMoveSched mouseMoveSched;
    ...
    public R<Object> turnOnAntiLockScreen(@PathVariable long antiLockScreenMinutes) throws Exception {
        ...
        return R.success(mouseMoveSched.turnOnAntiLockScreen(antiLockScreenMinutes));
    }

    @RequestMapping(value = "/turnOff")
    public R<Object> turnOffAntiLockScreen() {
        return R.success(mouseMoveSched.turnOffAntiLockScreen());
    }
}
