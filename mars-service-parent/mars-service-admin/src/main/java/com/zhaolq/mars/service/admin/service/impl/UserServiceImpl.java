...
public class UserServiceImpl extends AbstractService<UserEntity, String, UserMapper> implements IUserService {
    ...
    @Override
    public Page<UserEntity> getPageWithRole(UserEntity userEntity) {
        return userMapper.selectPageWithRole(userEntity, userEntity.getRole());
    }

    @Override
    public Page<UserEntity> getPageWithRole_multipleQueries(UserEntity userEntity) {
        return userMapper.getPageWithRole_multipleQueries(userEntity);
    }
